                ...
                {showInput ? (
                  <div className="main__form">
                    <TextField
                      ...
                      multiline
                      label = {`${(localStorage.getItem("isTeacher")==="true") ? "Post an Announcement": "Upload an Assignment"}`}
                      variant="filled"
                      value={inputValue}
                  ...
                  >
                    <Avatar />
                    {
                      (localStorage.getItem("isTeacher")==="true") ? <div>Post an Announcement</div>: <div>Upload an Assignment</div>
                    }
